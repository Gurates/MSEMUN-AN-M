...
export const CommitteesPage: React.FC<CommitteesPageProps> = ({
  ...
  return (
    <div
      ...
      className="relative min-h-screen pt-24 sm:pt-36 pb-8 sm:pb-16 overflow-hidden bg-[#060608] flex flex-col justify-between select-none"
      style={{
        perspective: '1400px'
      }}
    >
      ...
      <div className="section-container relative z-10 w-full flex-grow flex flex-col justify-between">
        ...
        {/* Top Header & Chamber Selector */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 mb-3 sm:mb-6">
          <div>
          ...
          {/* Chamber Quick-Selector Pills (Scrollable on Mobile) */}
          <div className="flex items-center gap-1.5 sm:gap-2 bg-[#0e0e16]/90 p-1 sm:p-1.5 rounded-xl border border-white/10 backdrop-blur-md overflow-x-auto no-scrollbar max-w-full">
        ...
        {/* 3D Stack Stage */}
        <div className="relative w-full h-[490px] sm:h-[580px] my-auto flex items-center justify-center">
          ...
          {COMMITTEES_DATA.map((committee, index) => {
            ...
            // TSBL MUN style 3D depth and scale transformation
            ...
            return (
              <div
                ...
                className="absolute top-1/2 left-1/2 rounded-2xl p-4 sm:p-8 flex flex-col justify-between transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] border border-white/12 shadow-[0_30px_90px_-20px_rgba(0,0,0,0.85)] cursor-pointer"
                style={{
              ...
              >
                ...
                <div className="flex items-center justify-between text-xs tracking-widest uppercase pb-2 sm:pb-3 border-b border-white/8">
                ...
                {/* Card Center: High-Definition Chamber Artwork */}
                <div className="relative my-2 sm:my-3 flex-grow rounded-xl overflow-hidden border border-white/10 bg-black/40 group">
                  <img
                    src={committee.image}
                    alt={committee.name}
                  ...
                  <div className="absolute bottom-2 left-2 sm:bottom-3 sm:left-3 px-2 sm:px-3 py-0.5 sm:py-1 rounded-md bg-black/70 backdrop-blur-md border border-white/10 text-[10px] sm:text-[11px] font-mono text-amber-300 flex items-center gap-1.5">
                ...
                <div className="pt-1 sm:pt-2">
                  ...
                  <div className="flex items-center justify-between pt-2 sm:pt-3 border-t border-white/8">
                    ...
                    <button
                      ...
                      className="btn-primary text-[11px] sm:text-xs !py-2 sm:!py-2.5 !px-3.5 sm:!px-5 !rounded-lg"
                    >
                      <span>APPLY</span>
          ...
          <div className="hidden xl:flex flex-col justify-between absolute right-4 top-1/2 -translate-y-1/2 w-[310px] p-6 rounded-2xl bg-[#0f0f1a]/92 border border-white/12 backdrop-blur-xl shadow-2xl z-30">
            <div>
          ...
          {/* Vertical Scroll / Nav Controls on Left (Hidden on very small screens, swipe is primary) */}
